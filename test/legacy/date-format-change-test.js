...
describe('Betterment PDF Parsing', () => {
  ...
  describe('Should Parse 2016-11-11 format PDFs with long description', () => {
    const quarterlyPdf = [
        ...
        ["888.428.9482"],
        ["Joint Build Wealth Goal"],
        ["Transaction Summary: Transfer to "],
        ["Warning  Test"],
        ["Beginning Balance"],
        ["Net Change"],
        ["Ending Balance"],
        ...
        ["3"],
        ["Value","Shares","Value"],
        ["A really long goal name for a test  Test -"],
        ["Rebalance"],
        ["Nov 22 2016","VTV","$90.76","-0.127","-$11.52","16.945","$1,537.89"],
        ["A really long goal name for a test  Test -"],
        ["Position Transfer"],
        ["Nov 22 2016","VTV","$90.75","-0.036","-$3.25","17.071","$1,549.24"],
        ["Nov 22 2016","VTI","$113.88","-0.029","-$3.25","13.393","$1,525.22"],
        ["Nov 22 2016","VOE","$96.59","-0.011","-$1.05","5.135","$495.99"],
        ["Nov 22 2016","VBR","$117.77","-0.008","-$0.93","3.795","$446.94"],
        ["1"],
        [" Betterment Securities acted as an agent for you and bought or sold securities on your behalf. "],
        [" Unless otherwise noted, the settlement date is three market days after the transaction date. For Mutual Funds, denoted by an underlined fund symbol, the"],
        ["2"],
        ["settlement date is one market day after the transaction date. "],
        [" Specific lot sales information: "],
        ["3"],
        ["For transaction A really long goal name for a test  Test   on Nov 22 2016: "],
        ["For ticker VTV: 0.126928  shares acquired on 5/19/15. "],
        ["Note: If this transaction included a sale of non-covered securities (purchased outside of Betterment and transferred into your account with incomplete lot"],
        ["information), the purchase date with respect to those lots may be an estimate."],
        ["Please review this document carefully. If details of any transaction are incorrect, you must immediately notify Betterment Securities at"],
        ["support@bettermentsecurities.com. Failure to make such notification within three (3) days of notification of this document constitutes your acceptance of the"],
    ...
    it('should return the right transactions', () => {
      const expectedTransactions = [
        createTransaction(
            ...
            "Joint Build Wealth Goal"),
        createTransaction(
            "11/22/2016", "A really long goal name for a test  Test - Position Transfer", "VTV", "90.75", "-3.25",
            "Joint Build Wealth Goal"),
        createTransaction(
            "11/22/2016", "A really long goal name for a test  Test - Position Transfer", "VTI", "113.88", "-3.25",
            "Joint Build Wealth Goal"),
        createTransaction(
            "11/22/2016", "A really long goal name for a test  Test - Position Transfer", "VOE", "96.59", "-1.05",
            "Joint Build Wealth Goal"),
        createTransaction(
            "11/22/2016", "A really long goal name for a test  Test - Position Transfer", "VBR", "117.77", "-0.93",
            "Joint Build Wealth Goal"),
      ];
